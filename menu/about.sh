...
echo "   - Whatsapp: 087793993385" | tee -a log-install.txt
echo "   - Telegram: @Anangfatkhurosidin" | tee -a log-install.txt
...
echo "    -------------------------" | tee -a log-install.txt
echo -e "\e[1;32m══════════════════ Autoscript By Anang vpn ══════════════════\e[0m" | tee -a log-install.txt
echo ""
