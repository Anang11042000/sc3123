...
NameUser=$(curl -sS https://raw.githubusercontent.com/Anang11042000/Izin/main/vps | grep $MYIP | awk '{print $2}')
cekdata=$(curl -sS https://github.com/Anang11042000/userbackup/main/$NameUser/$NameUser.zip | grep 404 | awk '{print $1}' | cut -d: -f1)
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
wget -q -O /root/backup/backup.zip "https://github.com/Anang11042000/userbackup/main/$nama/$nama.zip" &> /dev/null
