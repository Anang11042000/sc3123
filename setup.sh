...
#link izin ip vps
url_izin='https://raw.githubusercontent.com/Anang11042000/Izin/main/vps'
...
echo ""
wget -q https://raw.githubusercontent.com/Anang11042000/sc3123/main/tools.sh;chmod +x tools.sh;./tools.sh
mkdir -p /etc/slowdns
rm tools.sh
clear
...
echo ""
clear
	wget -O dnstt-server "https://raw.githubusercontent.com/Anang11042000/sc3123/main/slowdns/dnstt-server" >/dev/null 2>&1
	chmod +x dnstt-server >/dev/null 2>&1
	wget -O dnstt-client "https://raw.githubusercontent.com/Anang11042000/sc3123/main/slowdns/dnstt-client" >/dev/null 2>&1
	chmod +x dnstt-client >/dev/null 2>&1
	./dnstt-server -gen-key -privkey-file server.key -pubkey-file server.pub
	chmod +x *
	mv * /etc/slowdns
	wget -O /etc/systemd/system/client.service "https://raw.githubusercontent.com/Anang11042000/sc3123/main/slowdns/client" >/dev/null 2>&1
	wget -O /etc/systemd/system/server.service "https://raw.githubusercontent.com/Anang11042000/sc3123/main/slowdns/server" >/dev/null 2>&1
...
sleep 2
clear
wget https://raw.githubusercontent.com/Anang11042000/sc3123/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#!/bin/bash
cd
...
clear
cd
wget https://raw.githubusercontent.com/Anang11042000/UDP/main/udp.sh && chmod +x udp.sh && ./udp.sh
wget https://raw.githubusercontent.com/Anang11042000/UDP/main/zi.sh && chmod +x zi.sh && ./zi.sh
wget https://raw.githubusercontent.com/Anang11042000/UDP/main/req.sh && chmod +x req.sh && ./req.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/Anang11042000/sc3123/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
...
clear
cd /usr/sbin
wget https://raw.githubusercontent.com/Anang11042000/sc3123/main/funny.zip
unzip funny.zip
rm -fr funny.zip
clear
chmod +x /usr/sbin/*
